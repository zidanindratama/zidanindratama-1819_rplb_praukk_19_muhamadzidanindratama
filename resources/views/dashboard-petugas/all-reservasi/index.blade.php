                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div>
                                                ...
                                                <a href="/all-reservasi/create" class="btn btn-success">Tambah Reservasi</a>
                                            </div>
                                        </div>
                                        <!-- title -->
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="/all-reservasi/{{$reservasi->id}}" method="post">
                                                            ...
                                                            <a href="/order/creates/{{$reservasi->id}}" class="btn btn-success">Order</a>
                                                            @endif
                                                            <a href="/all-reservasi/{{$reservasi->id}}" class="btn btn-primary">Detail</a>
                                                            <a href="/all-reservasi/{{$reservasi->id}}/edit" class="btn btn-warning">Edit</a>
