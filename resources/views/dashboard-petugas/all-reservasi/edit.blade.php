...
<div class="col-md-12 mt-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- title -->
                                        <form action="/all-reservasi/{{$reservasi->id}}" method="post">
											@csrf
											@method('patch')
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="hidden" name="user_id" id="" class="form-control @error('user_id') is-invalid @enderror" value="{{$reservasi->user_id}}" placeholder="nama pelanggan" autocomplete="off">
														@error('user_id')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="name" id="" class="form-control @error('name') is-invalid @enderror" value="{{$reservasi->name}}" placeholder="nama pelanggan">
														@error('name')
                                                            <span class="invalid-feedback">Masukkan data yang benar!</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <select name="status" id="" class="form-control">
                                                            <option value="Booked" {{ $reservasi->status == 'Booked' ? 'selected' : '' }}>Booked</option>
                                                            ...
                                                            <option value="Finished" {{ $reservasi->status == 'Finished' ? 'selected' : '' }}>Finished</option>
                                                        </select>
														@error('status')
                                                            <span class="invalid-feedback">Masukkan data yang benar!</span>
                                                        @enderror
