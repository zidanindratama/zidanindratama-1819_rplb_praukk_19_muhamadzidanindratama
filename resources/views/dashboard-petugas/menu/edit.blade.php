                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="name" id="" class="form-control @error('name') is-invalid @enderror" value="{{$menu->name}}" placeholder="nama makanan">
                                                        @error('name')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="number" name="price" id="" class="form-control @error('price') is-invalid @enderror" value="{{$menu->price}}" placeholder="harga makanan">
                                                        @error('price')
                                                            <span class="invalid-feedback">Masukkan data yang benar!</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="" cols="30" rows="10">{!! $menu->deskripsi !!}</textarea>
                                                        @error('deskripsi')
                                                            <span class="invalid-feedback">Masukkan data yang benar!</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="gambar" class="custom-file-input" id="validatedCustomFile" value="{{$menu->gambar}}">
